...
if [[ "${1:-}" == "--install-desktop-link" ]]; then
  ...
  chmod +x "$REPO_ROOT/scripts/run_demo.sh" "$REPO_ROOT/scripts/run_web_demo.sh" "$REPO_ROOT/scripts/run_qt_demo.sh"
  ln -sfn "$REPO_ROOT/scripts/run_web_demo.sh" "$desktop_dir/run_aria_web_demo.sh"
  ln -sfn "$REPO_ROOT/scripts/run_qt_demo.sh" "$desktop_dir/run_aria_qt_demo.sh"
  ln -sfn "$REPO_ROOT/scripts/run_web_demo.sh" "$desktop_dir/run_aria_demo.sh"
  rm -f "$desktop_dir/run_aria_opencv_demo.sh"
  echo "Installed desktop launchers:"
  echo "  $desktop_dir/run_aria_web_demo.sh"
  echo "  $desktop_dir/run_aria_qt_demo.sh"
